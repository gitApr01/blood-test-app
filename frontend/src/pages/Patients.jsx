...
export default function Patients(){
  ...
  useEffect(()=>{ async function l(){ try{ const r=await fetch("https://blood-test-app.onrender.com/all_tests"); const j=await r.json(); const byName = {}; j.forEach(it=>{ if(!byName[it.patient_name]) byName[it.patient_name]=it; }); setList(Object.values(byName)); }catch(e){console.error(e);} } l(); },[]);
