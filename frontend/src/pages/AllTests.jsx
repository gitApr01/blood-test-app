...
export default function AllTests(){
  ...
  async function load(){ setLoading(true); try { const r = await fetch("https://blood-test-api.onrender.com/all_tests"); const j=await r.json(); setData(j);} catch(e){console.error(e);} setLoading(false); }
  useEffect(()=>{ load(); },[]);
  return <>
